      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-chakra text-2xl font-bold uppercase tracking-tight text-white">
                Tuning<span className="text-primary">Találkozók</span>
              </h2>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-base text-zinc-400" style={{ color: '#FF856E' }}>
              Ha nem tudsz újra bejelentkezni, kérlek aktiváld a fiokod. (Email-ben kaptad)
            </p>
          </div>
